...
<nav class="mt-3 mx-3" aria-label="breadcrumb" id="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<?= base_url('coa') ?>">Akun</a></li>
  </ol>
</nav>
    ...
    <div class="card shadow-sm">
      <div class="card-header pb-0 px-0">
        <ul class="nav nav-tabs px-2">
          <li class="nav-item">
            <a class="nav-link text-dark" data-nav-id="index" href="<?= base_url('coa') ?>">Halaman Utama</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark" data-nav-id="data" href="<?= base_url('coa/data') ?>">Semua Akun</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark" data-nav-id="new" href="<?= base_url('coa/new') ?>">Buat Akun Baru</a>
          </li>
        </ul>
      </div>
      <div class="card-body">
