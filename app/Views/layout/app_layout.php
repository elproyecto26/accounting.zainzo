    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item mx-1">
          <a class="nav-link" data-navbar-id="dashboard" href="<?= base_url('dashboard') ?>">Dashboard</a>
        </li>
        <li class="nav-item mx-1">
          <a class="nav-link" data-navbar-id="cash-and-bank" href="<?= base_url('cash-and-bank') ?>">Kas & Bank</a>
        </li>
        <li class="nav-item mx-1">
          <a class="nav-link" data-navbar-id="expenses" href="<?= base_url('expenses') ?>">Biaya - Biaya</a>
        </li>
        <li class="nav-item mx-1">
          <a class="nav-link" data-navbar-id="coa" href="<?= base_url('coa') ?>">Akun</a>
        </li>
        <li class="nav-item mx-1">
          <a class="nav-link" data-navbar-id="journal" href="<?= base_url('journal') ?>">Jurnal Umum</a>
        </li>
        <li class="nav-item mx-1">
          <a class="nav-link" data-navbar-id="ledger" href="<?= base_url('ledger') ?>">Buku Besar</a>
        </li>
